...
if prompt:
    ...
    with st.chat_message("assistant", avatar=AVATAR_ASSISTANT):
        ...
        # Multi-tool cross-domain tracking. When router dispatches both
        # diet_tool and workout_tool in the same turn (e.g. "show my diet
        # and workout plan"), we receive one ToolMessage per tool. Stitch
        # them into one response grouped by tool label.
